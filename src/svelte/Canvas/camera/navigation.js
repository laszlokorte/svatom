...
export function rotateWithPivotScreen(delta, orig) {
  ...
  return rotateWithPivot(
    { px: pivotWorldX, py: pivotWorldY, dw: delta.dw },
    orig,
  );
}
...
export const pivotRotationLens = L.lens(
  rotateWithPivotZeroDelta,
  rotateWithPivot,
);
export const pivotZoomScreenLens = L.lens(
  zoomWithPivotZeroDelta,
  zoomWithPivotScreen,
);
export const pivotRotationScreenLens = L.lens(
  rotateWithPivotZeroDelta,
